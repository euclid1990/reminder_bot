...
- Với User đã lên Pro, muốn có API phải request qua người quản lý group, nhờ điền mail vào trang sau và gửi request: https://www.chatwork.com/service/packages/chatwork/subpackages/api/apply_beta.php
